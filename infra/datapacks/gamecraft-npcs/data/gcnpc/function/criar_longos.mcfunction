# Boneco do JOGOS LONGOS: quatro pecas que nascem juntas e morrem juntas.
#
...
# 2. a placa do nome, na escala 1.11 — calculada pelo comprimento de "JOGOS LONGOS",
#    para nome curto e nome longo darem quase a mesma largura.
summon minecraft:text_display ~ ~2.5 ~ {Tags:["gcnpc","gcnpc_longos","gcnpc_placa"],text:{"text":"JOGOS LONGOS","color":"light_purple","bold":true},billboard:"center",see_through:0b,background:0,alignment:"center",transformation:{scale:[1.11f,1.11f,1.11f],translation:[0f,0f,0f],left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f]}}
