# Boneco do MEGAGAMES: quatro pecas que nascem juntas e morrem juntas.
#
...
# 2. a placa do nome, na escala 1.11 — calculada pelo comprimento de "MEGAGAMES",
#    para nome curto e nome longo darem quase a mesma largura.
summon minecraft:text_display ~ ~2.5 ~ {Tags:["gcnpc","gcnpc_longos","gcnpc_placa"],text:{"text":"MEGAGAMES","color":"light_purple","bold":true},billboard:"center",see_through:0b,background:0,alignment:"center",transformation:{scale:[1.48f,1.48f,1.48f],translation:[0f,0f,0f],left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f]}}
...
summon minecraft:text_display ~ ~2.2 ~ {Tags:["gcnpc","gcnpc_longos","gcnpc_num"],text:{"text":"","color":"gray"},billboard:"center",see_through:0b,background:0,alignment:"center",transformation:{scale:[0.85f,0.85f,0.85f],translation:[0f,0f,0f],left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f]}}
...
tellraw @s [{"text":"Boneco do MEGAGAMES criado. ","color":"green"},{"text":"Clique nele para abrir o menu.","color":"gray"}]
