...
summon minecraft:mannequin ~ ~ ~ {Tags:["gcnpc","gcnpc_eventos","gcnpc_novo"],profile:"JulioCasare",hide_description:1b,immovable:1b,Invulnerable:1b,Silent:1b}
