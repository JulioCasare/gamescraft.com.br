...
#    aceita tamanho. A escala 1.39 vem do comprimento de "BUILD BATTLE": a placa fica
#    com cerca de um bloco para cada lado da cabeca, seja o nome curto ou longo.
summon minecraft:text_display ~ ~2.35 ~ {Tags:["gcnpc","gcnpc_build"],text:{"text":"BUILD BATTLE","color":"green","bold":true},billboard:"center",see_through:0b,background:0,alignment:"center",transformation:{scale:[1.39f,1.39f,1.39f],translation:[0f,0f,0f],left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f]}}
