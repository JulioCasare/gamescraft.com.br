# Boneco do BUILD BATTLE: quatro pecas que nascem juntas e morrem juntas.
#
...
summon minecraft:mannequin ~ ~ ~ {Tags:["gcnpc","gcnpc_build","gcnpc_novo"],profile:"JulioCasare",hide_description:1b,immovable:1b,Invulnerable:1b,Silent:1b,PersistenceRequired:1b}
# 2. a placa do nome, na escala 1.11 — calculada pelo comprimento de "BUILD BATTLE",
#    para nome curto e nome longo darem quase a mesma largura.
summon minecraft:text_display ~ ~2.5 ~ {Tags:["gcnpc","gcnpc_build","gcnpc_placa"],text:{"text":"BUILD BATTLE","color":"green","bold":true},billboard:"center",see_through:0b,background:0,alignment:"center",transformation:{scale:[1.11f,1.11f,1.11f],translation:[0f,0f,0f],left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f]}}
...
summon minecraft:text_display ~ ~2.2 ~ {Tags:["gcnpc","gcnpc_build","gcnpc_num"],text:{"text":"","color":"gray"},billboard:"center",see_through:0b,background:0,alignment:"center",transformation:{scale:[0.85f,0.85f,0.85f],translation:[0f,0f,0f],left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f]}}
