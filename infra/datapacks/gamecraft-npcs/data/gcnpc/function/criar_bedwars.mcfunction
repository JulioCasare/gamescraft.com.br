# Boneco do BED WARS: quatro pecas que nascem juntas e morrem juntas.
#
...
# 2. a placa do nome, na escala 1.60 — calculada pelo comprimento de "BED WARS",
#    para nome curto e nome longo darem quase a mesma largura.
summon minecraft:text_display ~ ~2.5 ~ {Tags:["gcnpc","gcnpc_bedwars","gcnpc_placa"],text:{"text":"BED WARS","color":"aqua","bold":true},billboard:"center",see_through:0b,background:0,alignment:"center",transformation:{scale:[1.60f,1.60f,1.60f],translation:[0f,0f,0f],left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f]}}
...
summon minecraft:text_display ~ ~2.2 ~ {Tags:["gcnpc","gcnpc_bedwars","gcnpc_num"],text:{"text":"","color":"gray"},billboard:"center",see_through:0b,background:0,alignment:"center",transformation:{scale:[0.85f,0.85f,0.85f],translation:[0f,0f,0f],left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f]}}
