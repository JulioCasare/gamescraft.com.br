# Boneco do BED WARS: tres pecas que nascem juntas e morrem juntas.
#
...
summon minecraft:text_display ~ ~2.35 ~ {Tags:["gcnpc","gcnpc_bedwars"],text:{"text":"BED WARS","color":"aqua","bold":true},billboard:"center",see_through:0b,background:0,alignment:"center",transformation:{scale:[2.00f,2.00f,2.00f],translation:[0f,0f,0f],left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f]}}
