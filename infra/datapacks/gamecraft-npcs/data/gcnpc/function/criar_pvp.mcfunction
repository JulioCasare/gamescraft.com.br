...
summon minecraft:text_display ~ ~2.35 ~ {Tags:["gcnpc","gcnpc_pvp"],text:{"text":"PVP","color":"red","bold":true},billboard:"center",see_through:0b,background:0,alignment:"center",transformation:{scale:[1.60f,1.60f,1.60f],translation:[0f,0f,0f],left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f]}}
