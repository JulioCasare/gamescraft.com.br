...
execute if score #mt gc_r matches 13 run summon minecraft:ravager ~ ~ ~ {Tags:["gc_mob","gc_novo"],PersistenceRequired:1b,attributes:[{id:"minecraft:max_health",base:100}],Health:100f}
