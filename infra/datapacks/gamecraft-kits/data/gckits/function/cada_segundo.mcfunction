...
# Nome e vida na cabeca de cada mob. E reescrito toda vez porque o nome de
# entidade nao acompanha a vida sozinho: o placar que faz isso para jogador nao
# vale para mob.
execute as @e[tag=gc_mob] run function gckits:mob_nome
